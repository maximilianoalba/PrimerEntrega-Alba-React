...
<div className=" bg-green-200 h-screen p-10">
      <div className="w-80 m-auto max-w-sm pb-20">
        <img src="https://cdn.pixabay.com/photo/2020/10/03/12/32/tablet-5623396_1280.jpg" alt="" className="rounded-t-2xl shadow-2xl lg:w-full 2xl:w-full 2xl:h-44 object-cover"/>
        <div className=" bg-emerald-200 shadow-2xl rounded-b-3xl">
          ...
          <div className="grid grid-cols-4 w-72 lg:w-5/6 m-auto bg-indigo-300 mt-5 p-4 lg:p-4 rounded-2xl">
...
>
  {copied ? "Tu ID se ha copiado en tu portapapeles" : "Copiar el ID"}
          ...
          <Link to="/"> 
            <button className=" bg text-gray-500 font-bold lg:text-sm hover:text-gray-900">Volver a la tienda</button>
            </Link>
          </div>
        </div>
      </div>
